...
impl FromWorld for WorldAssets {
    fn from_world(world: &mut World) -> Self {
        ...
        let mut images: HashMap<&'static str, Handle<Image>> = HashMap::from([
            ...
            ("rogue_human_man", assets.load("images/classes/rogue_human_man.png")),
            ("rogue_human_woman", assets.load("images/classes/rogue_human_woman.png")),
            ("rogue_elf_man", assets.load("images/classes/rogue_elf_man.png")),
            ("rogue_elf_woman", assets.load("images/classes/rogue_elf_woman.png")),
            ("rogue_dwarf_man", assets.load("images/classes/rogue_dwarf_man.png")),
            ("rogue_dwarf_woman", assets.load("images/classes/rogue_dwarf_woman.png")),
            ("rogue_orc_man", assets.load("images/classes/rogue_orc_man.png")),
            ("rogue_orc_woman", assets.load("images/classes/rogue_orc_woman.png")),
